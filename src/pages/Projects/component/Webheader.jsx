  ...
  return (
    <div className='px-5 py-5 border-b border-gray-200 fixed top-0 left-0 w-full zindex-999 bg-gray-100'>
        <div className='xl:max-w-1220px 2xl:max-w-1440 mx-auto'>
            ...
            <ul className={`xl:flex items-center transition-all ease-in-out duration-700 shadow-2xl xl:shadow-none block fixed top-0 space-y-5 px-8 py-10 xl:!p-0 xl:space-y-0 right-0 w-80 xl:relative xl:w-unset xl:h-unset xl:bg-transparent h-screen bg-white gap-10 font-Kanit ${isOpen ? 'translate-x-0' : 'translate-x-96 md:translate-x-440px xl:translate-x-0'}`}  >
                 <li
                 onClick={handleClose}
                ...
                <li className='py-2.5'>
                 ...
                 <li
                    className="relative py-2.5 flex items-center gap-2.5 group/menu transition-all ease-in-out duration-500"
            ...
            onMouseLeave={() => toggleSubMenu(null)}
                ...
                <li className='py-2.5 group/menu transition-all ease-in-out duration-500 relative' onMouseEnter={() => toggleSubMenu("blog")} onMouseLeave={() => toggleSubMenu(null)}>
                     ...
                     {openMenu === "blog" && (
                        ...
                        <div className='grid grid-cols-2 gap-2'>
                            <ul className='space-y-2 '>
                                ...
                                <li><Link to="/" className=' text-sm font-Kanit font-normal hover:text-amber-300 transition-all duration-300 ease-in-out text-white'>Blog Details</Link></li>

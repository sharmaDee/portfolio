...
<div className='max-w-1440 mx-auto'>
        <div className='grid-cols-2 grid gap-10'>
            <div className='relative space-y-4 '>
                <h2 className='text-80px font-Teko font-bold text-Webblack leading-20 uppercase'>Trusted clients testimonial</h2>
                <p className='text-Davy max-w-80 font-normal font-Kanit text-base'>Consumers today rely heavily on digital means to research products. We research a brand of bldend</p>
        ...
        <SwiperSlide>
            <div className='w-96  bg-gray-100 relative'>
                ...
                <div className='flex items-baseline gap-2'>
                    <h4 className='text-5xl font-semibold font-Teko text-Webblack'>4.9</h4>
                    <FontAwesomeIcon icon={faStar} className='text-yellow-400' />
                </div>
                <p className='font-Kanit text-Davy text-base'>(out of 5 stars)</p>
                <p className='text-Davy text-xl font-bold mt-8'>We full service digital agency that build’s fascinating users experiences.</p>
                </div>
                
                <div className='bg-Webblack p-6 flex items-start gap-4'>
                    <div className='w-10 h-10 rounded-full bg-white overflow-hidden'>
                        <img src={Testimonialpeople} alt='Testimonialpeople' className='w-full h-full object-cover'/>
                    </div>
                    <div className='space-y-0'>
                        <h4 className='text-xl font-Teko leading-5 font-semibold text-white'>Ceyhan Özçivit</h4>
                        <p className='text-base font-Kanit font-normal text-gray-400'>Mid-Level Developer</p>
                    </div>
                </div>

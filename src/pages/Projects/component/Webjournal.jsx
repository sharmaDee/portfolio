...
export const Webjournal = () => {
  return (
    <>
    <div className='px-5 pt-0 py-24'>
        <div className='max-w-1440 mx-auto space-y-14'>
            <div className='flex justify-between gap-4'>
                <h2 className='font-Teko text-80px font-bold text-Webblack uppercase leading-20'>journal insight<br/>of Yoks</h2>
            ...
            <div className='grid grid-cols-3 gap-8'>
                <div className='relative space-y-8 group/insight bg-Webblack p-10 transition-all ease-in-out duration-500 hover:bg-orange-300 overflow-hidden'>
                    <h2 className='uppercase text-4xl font-Teko underline font-bold text-white'>Arolax the quest exceptional talent our team</h2>
                    <div className='-mr-10'>
                    ...
                    <div className='relative space-y-4'>
                        ...
                        <div className='space-y-0'>
                            <h4 className='font-Teko text-2xl font-medium text-white'>Oliver Kugar</h4>

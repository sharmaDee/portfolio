      ...
      <div className="py-20 px-5">
        <div className="xl:max-w-1220px  mx-auto space-y-16">
          <div className="flex flex-col justify-between space-y-10">
            <h1 className="font-Noto text-4xl lg:text-5xl xl:text-100px  xl:leading-28 font-normal text-Webblack">
              Donate your design for newest designer to try better
            </h1>
            <div className="grid grid-cols-3 gap-4 max-w-400px min-w-500px">
              <div className="space-y-1 border-r border-black/15 pr-3">
                <h4 className="text-4xl  text-Webblack font-Kanit">
                  320<span className="font-thin ml-1.5">+</span>
                </h4>
                <span className="text-base font-normal text-Davy font-Kanit">
                  Comments
                </span>
              </div>
              <div className="space-y-1 pl-3 border-r border-black/15 pr-3">
                <h4 className="text-4xl  text-Webblack font-Kanit">
                  20,511<span className="font-thin ml-1.5">+</span>
                </h4>
                <span className="text-base font-normal text-Davy font-Kanit">
                  Likes
                </span>
              ...
              <div className="space-y-1 pl-3 pr-3">
                <h4 className="text-4xl  text-Webblack font-Kanit">
                  01<span className="font-thin ml-1.5">+</span>
                </h4>
                <span className="text-base font-normal text-Davy font-Kanit">
                  November
                </span>
            ...
            <div className="max-w-4xl mx-auto space-y-10">
              <div className="bg-linear-to-r relative from-Webblack to-neutral-600 p-12 grid grid-flow-col gap-10">
                ...
                <div className="space-y-3">
                  <h4 className="text-5xl font-Teko font-normal text-white">
                    Comfortable full leather lining eye-catching unique detail
                    to the toe low ‘cut-away’ sides clean and sleek harmony.
                  </h4>
              ...
              <div className="space-y-4">
                <p className="text-base font-Kanit text-Davy">
                  We love to bring designs to life as a developer, and I aim to
                  do this using whatever front end tools aren't necessary. my
                  preferred tools are more moderns JavaScript libraries like
                  React.js but I like use whatever best for the websites needs.
                  There are several reasons why a business would consider a
                  rebrand and it doesn’t necessarily mean the business has been
                  unsuccessful.
                </p>
                <p className="text-base font-Kanit text-Davy">
                  We love to bring designs to life as a developer, and I aim to
              ...
              <div className="space-y-5">
                <h4 className="font-Noto text-4xl text-Webblack font-semibold">
                  Research & strategy
                </h4>
                <p className="text-base font-Kanit text-Davy">
                  We love to bring designs to life as a developer, and I aim to
              ...
              <div className="space-y-5">
                ...
                <p className="text-base font-Kanit text-Davy">
                  ...
                  to our own platform, Our analytical eye create a site that was
                  visually engaging and also optimised for maximum performance.
                  It also perfectly reflects the journey to help it tell a story
                  to increase its understanding and drive action. To create a
                  site that was visually engaging for maximum performance.
                </p>
                <p className="text-base font-Kanit text-Davy">
                  We love to bring designs to life as a developer, and I aim to
                  do this using whatever front end tools aren't necessary. my
                ...
                <ul>
                  <li className="space-x-2 text-base flex gap-3 items-center text-Webblack font-Kanit">
                    <span className="block text-2xl font-normal text-Webblack">
                      +
                    </span>
                    Brand Development
                  </li>
              ...
              <div className="space-y-5">
                ...
                <p className="text-base font-Kanit text-Davy">
                  ...
                  :not() can be chained with other pseudon classes and
              ...
              <div className="space-y-5">
                <h4 className="font-Noto text-4xl text-Webblack">
                  Write a comment
                </h4>
                <div className="mt-5 md:mt-10">
                  <form className="space-y-5">
                    ...
                    <div className="mt-12">
                      <button
                        type="button"
                        className=" text-sm hidden xl:block uppercase text-white font-Kanit py-3.5 px-10 rounded-tr-2xl rounded-bl-2xl bg-Webblack"
                      >
                        Sumbit
                      </button>
                    </div>
          ...
          <div className="space-y-10">
            <h4 className="text-4xl text-Webblack font-Kanit font-normal">
              Related articles
            </h4>

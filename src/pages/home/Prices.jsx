                ...
                <div className="rounded-2xl p-1 pt-8 bg-linear-to-bl transition-all ease-in-out duration-500 cursor-pointer hover:shadow-card from-Primary to-green-700 space-y-6 ">
                  ...
                  <div className="rounded-2xl bg-gradient-to-br from-Eerieblack to-gray-800 px-6 py-8">
                    ...
                    <ul className="my-10 space-y-5">
                      ...
                      <svg class="shrink-0 w-4 h-4 text-Primary " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                          <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                      </svg>
                      <span class="text-base font-normal leading-tight text-gray-400  ms-3">2 team members</span>
                      </li>
                      <li className="flex items-center ">
                      ...
                      <svg class="shrink-0 w-4 h-4 text-gray-400 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                          <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                      </svg>
                      <span class="text-base font-normal leading-tight text-gray-400  ms-3">2 team members</span>
                      </li>

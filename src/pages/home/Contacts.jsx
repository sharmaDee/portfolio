...
export const Contacts = () => {
  return (
    <>
    <div className='py-10 xl:py-20 2xl:py-24' id="contact" name="section8" data-aos="zoom-in" data-aos-duration="1000" data-aos-offset="100" data-aos-delay="460">
            ...
            <div className="space-y-6 2xl:space-y-10 max-w-2xl">
              <div className="rounded-4xl py-2 px-5 border border-white/20 inline-flex items-center gap-2">
               ...
               <Messageicon className="stroke-white/80 w-3 h-3 stroke-2 hover:stroke-Primary transition-all ease-in-out duration-300"/>
                ...
                <h2 className="text-3xl md:text-4xl xl:text-5xl leading-14 font-poppins font-thin poppins-thin text-white">Let's Work <span className="font-medium text-Primary">Together!</span></h2>
